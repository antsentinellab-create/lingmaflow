...
- [ ] 1.1 在 lingmaflow/core/condition_checker.py 新增 BehaveConditionChecker class,支援 parse behave: prefix
- [ ] 1.2 實作 BehaveConditionChecker.check() 方法,執行 subprocess.run(["behave", feature_path])
...
- [ ] 2.1 建立 lingmaflow/core/feature_lock.py 模組,實作 FeatureLock class
- [ ] 2.2 實作 FeatureLock.lock(feature_path) 方法,計算 SHA256 hash 並寫入 .lingmaflow/feature_locks.json
...
- [ ] 3.1 在 lingmaflow/cli/commands.py 新增 feature-lock 指令,支援單一檔案與 --all 參數
- [ ] 3.2 在 lingmaflow/cli/commands.py 新增 feature-verify 指令,檢查單一檔案 hash 一致性
